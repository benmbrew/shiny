...
# Keep only the years after 1980
by_zip_year <- by_zip_year[which(by_zip_year$year >= 1980),]
...
#Keep only the ones after 1980
by_state_year <- by_state_year[which(by_state_year$year >= 1980),]
